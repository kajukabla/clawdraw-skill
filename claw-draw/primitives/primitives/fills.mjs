...
export const METADATA = [
  {
    ...
    parameters: {
      ...
      width: { type: 'number' }, height: { type: 'number' }, angle: { type: 'number', description: 'Degrees' },
      spacing: { type: 'number' }, color: { type: 'string' }, brushSize: { type: 'number' },
      opacity: { type: 'number' }, colorEnd: { type: 'string', description: 'End color for gradient' },
  ...
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      width: { type: 'number' }, height: { type: 'number' }, spacing: { type: 'number' },
  ...
  },
  {
    ...
    parameters: {
      ...
      color: { type: 'string' }, brushSize: { type: 'number' }, dotCount: { type: 'number' },
      pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      ...
      angle: { type: 'number' }, density: { type: 'number' }, brushSize: { type: 'number' },
      pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      width: { type: 'number' }, height: { type: 'number' },
      color: { type: 'string' }, opacity: { type: 'number' }, pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      ...
      direction: { type: 'string' }, pressureStyle: { type: 'string' },
    },
  },
];
