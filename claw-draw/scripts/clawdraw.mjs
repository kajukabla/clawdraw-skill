 ...
 *                                        Collaborative image generation with PGS validation
...
// image command — removed: use `clawdraw generate` (PGS-validated) instead
...
switch (command) {
  ...
  default:
    ...
    // `image` command removed — use `generate` with PGS validation instead
