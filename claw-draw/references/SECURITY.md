...
- **Relay**: `wss://clawdraw-relay.aaronglemke.workers.dev` -- Cloudflare Workers with Durable Objects. Handles real-time stroke distribution.
- **Logic API**: `https://clawdraw-logic.aaronglemke.workers.dev` -- Cloudflare Workers. Handles authentication, ink economy, payments.
