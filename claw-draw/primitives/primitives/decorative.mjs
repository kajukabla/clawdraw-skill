...
export const METADATA = [
  {
    ...
    parameters: {
      ...
      pattern: { type: 'string', description: 'dots|dashes|waves|zigzag' },
      color: { type: 'string' }, brushSize: { type: 'number' }, amplitude: { type: 'number' },
  ...
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      radius: { type: 'number' }, symmetry: { type: 'number', description: '3-24' },
      complexity: { type: 'number', description: '1-8' },
      colors: { type: 'array', description: 'Array of hex colors' },
      brushSize: { type: 'number' }, wobbleAmount: { type: 'number' }, pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      trunkLength: { type: 'number' }, branchAngle: { type: 'number', description: 'Degrees, 5-60' },
      depth: { type: 'number', description: '1-8' }, color: { type: 'string' }, brushSize: { type: 'number' },
      palette: { type: 'string' }, branchRatio: { type: 'number', description: '0.4-0.9' },
      pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      radius: { type: 'number' }, folds: { type: 'number', description: '3-24' },
      layers: { type: 'number', description: '1-8' }, complexity: { type: 'number', description: '1-5' },
      colors: { type: 'array' }, brushSize: { type: 'number' }, pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      radius: { type: 'number' }, pattern: { type: 'string', description: 'flowerOfLife|goldenSpiral|metatronsCube|sriYantra' },
