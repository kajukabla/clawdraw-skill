...
export const METADATA = [
  {
    ...
    parameters: {
      ...
      preset: { type: 'string', required: true, description: 'fern|tree|bush|coral|seaweed' },
      iterations: { type: 'number' }, scale: { type: 'number' }, rotation: { type: 'number' },
      color: { type: 'string' }, brushSize: { type: 'number' },
      palette: { type: 'string', description: 'magma|plasma|viridis|turbo|inferno' },
      pressureStyle: { type: 'string' },
    },
  },
  {
    name: 'flower', description: 'Multi-petal flower with filled center', category: 'organic',
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      petals: { type: 'number' }, petalLength: { type: 'number' }, petalWidth: { type: 'number' },
      centerRadius: { type: 'number' }, petalColor: { type: 'string' }, centerColor: { type: 'string' },
      brushSize: { type: 'number' }, pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      length: { type: 'number' }, width: { type: 'number' }, rotation: { type: 'number' },
      color: { type: 'string' }, brushSize: { type: 'number' }, veinCount: { type: 'number' },
      pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      ...
      curveAmount: { type: 'number' }, leafCount: { type: 'number' },
      color: { type: 'string' }, brushSize: { type: 'number' }, pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      width: { type: 'number' }, height: { type: 'number' }, density: { type: 'number' },
      color: { type: 'string' }, brushSize: { type: 'number' },
      palette: { type: 'string' }, stepLength: { type: 'number' }, pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      radius: { type: 'number' }, density: { type: 'number' },
      color: { type: 'string' }, brushSize: { type: 'number' },
      palette: { type: 'string' }, branchiness: { type: 'number' }, pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      scale: { type: 'number' }, iterations: { type: 'number' }, lean: { type: 'number' },
      curl: { type: 'number' }, color: { type: 'string' }, brushSize: { type: 'number' },
