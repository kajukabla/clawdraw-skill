...
export const METADATA = [
  {
    ...
    parameters: {
      points: { type: 'array', required: true, description: 'Array of {x, y} control points' },
  ...
  },
  {
    ...
    parameters: {
      ...
      dashLength: { type: 'number' }, gapLength: { type: 'number' },
  ...
  },
  {
    ...
    parameters: {
      startX: { type: 'number', required: true }, startY: { type: 'number', required: true },
      endX: { type: 'number', required: true }, endY: { type: 'number', required: true },
      headSize: { type: 'number' }, color: { type: 'string' }, brushSize: { type: 'number' },
      pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      ...
      text: { type: 'string', required: true }, charHeight: { type: 'number' },
      color: { type: 'string' }, brushSize: { type: 'number' }, opacity: { type: 'number' },
      rotation: { type: 'number', description: 'Degrees' }, pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      count: { type: 'number', description: '1-20' }, glyphSize: { type: 'number' },
      arrangement: { type: 'string', description: 'line|grid|scatter|circle' },
      color: { type: 'string' }, brushSize: { type: 'number' }, opacity: { type: 'number' },
      pressureStyle: { type: 'string' },
    },
  },
