...
export const METADATA = [
  {
    ...
    parameters: {
      ...
      preset: { type: 'string', required: true, options: ['fern', 'tree', 'bush', 'coral', 'seaweed'], description: 'L-System preset' },
      iterations: { type: 'number', min: 1, max: 5, description: 'Iteration depth (max varies by preset)' },
      scale: { type: 'number', min: 0.1, max: 5, default: 1, description: 'Size multiplier' },
      rotation: { type: 'number', description: 'Starting rotation in degrees' },
      color: { type: 'string' }, brushSize: { type: 'number', min: 3, max: 100 },
      palette: { type: 'string', options: ['magma', 'plasma', 'viridis', 'turbo', 'inferno'], description: 'Color palette' },
  ...
  },
  {
    ...
    parameters: {
      ...
      centerRadius: { type: 'number', min: 5, max: 100, default: 20, description: 'Center size' },
      petalColor: { type: 'string', description: 'Petal hex color' },
      centerColor: { type: 'string', description: 'Center hex color' },
      brushSize: { type: 'number', min: 3, max: 100 }, pressureStyle: { type: 'string' },
    },
  },
  {
