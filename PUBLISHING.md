...
|---------|------|-----------|
| 4.0.0 | 2026-02-21 | Major version: remove `__SKILL_TEST_RELAY_URL` env var override from roam.mjs, 11 new security tests (manifest consistency, dependency declarations, open package isolation, publish boundary), Scanner Transparency Checklist in SECURITY.md |
