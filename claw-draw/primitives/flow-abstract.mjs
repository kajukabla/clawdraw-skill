...
export const METADATA = [
  {
    ...
    parameters: {
      ...
      noiseScale: { type: 'number', min: 0.001, max: 0.1, default: 0.01, description: 'Noise frequency' },
      density: { type: 'number', min: 0.1, max: 1, default: 0.5, description: 'Particle density' },
      segmentLength: { type: 'number', min: 1, max: 30, default: 5, description: 'Step size' },
      color: { type: 'string' }, brushSize: { type: 'number', min: 3, max: 100 },
      palette: { type: 'string', description: 'Color palette' },
      traceLength: { type: 'number', min: 5, max: 200, default: 40, description: 'Steps per trace' },
  ...
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      turns: { type: 'number', min: 0.5, max: 20, default: 3, description: 'Number of turns' },
      startRadius: { type: 'number', min: 0, max: 500, default: 5, description: 'Inner radius' },
      endRadius: { type: 'number', min: 1, max: 500, default: 100, description: 'Outer radius' },
      color: { type: 'string' }, brushSize: { type: 'number', min: 3, max: 100 },
  ...
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      freqX: { type: 'number', min: 1, max: 20, default: 3, description: 'X frequency' },
      freqY: { type: 'number', min: 1, max: 20, default: 2, description: 'Y frequency' },
      phase: { type: 'number', description: 'Phase offset in degrees' },
      amplitude: { type: 'number', min: 10, max: 500, default: 80, description: 'Curve size' },
      color: { type: 'string' }, brushSize: { type: 'number', min: 3, max: 100 },
      palette: { type: 'string', description: 'Color palette' },
      pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      type: { type: 'string', options: ['lorenz', 'aizawa', 'thomas'], default: 'lorenz', description: 'Attractor type' },
      iterations: { type: 'number', min: 100, max: 5000, default: 2000, description: 'Point count' },
      scale: { type: 'number', min: 0.1, max: 50, default: 5, description: 'Display scale' },
      color: { type: 'string' }, brushSize: { type: 'number', min: 3, max: 100 },
      palette: { type: 'string', description: 'Color palette' },
      timeStep: { type: 'number', min: 0.001, max: 0.02, default: 0.005, description: 'Integration step' },
      pressureStyle: { type: 'string' },
    },
  },
  {
    ...
    parameters: {
      cx: { type: 'number', required: true }, cy: { type: 'number', required: true },
      outerR: { type: 'number', min: 10, max: 500, default: 100, description: 'Outer ring radius' },
      innerR: { type: 'number', min: 5, max: 400, default: 40, description: 'Inner ring radius' },
      traceR: { type: 'number', min: 1, max: 400, default: 30, description: 'Trace point distance' },
      revolutions: { type: 'number', min: 1, max: 50, default: 10, description: 'Number of revolutions' },
      color: { type: 'string' }, brushSize: { type: 'number', min: 3, max: 100 },
      palette: { type: 'string', description: 'Color palette' },
